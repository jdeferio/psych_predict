...
print(rfe.support_)
print(rfe.ranking_)
# 2 5 7 10 11 13 14 15 16 17 20 22 23 24 27-32 35-36 40-42 46 48-49 52-53 56 58 73 78 87

# IMPLEMENT THE MODEL
cols = ['alzheimers','a_fib','cataract','depression','diabetes','heart_fail','hip_pelv_frac','hyperlipid','htn','ischemic_hd','stroke_tia','colorectal_ca','prostate_ca','lung_ca','anxiety','autism','bipolar','cerebral_p','cystic_f','epilepsy','iq_disable','learn_disable','mobility','ms_tm','muscular_dys','personality','ulcers','schizo','spina_bifida','spinal_cord','hepatitis','suicide','nychaperc','ozone','inpt_2012']
...
plt.title('Receiver operating characteristic: Clinical + 1600m SDOH')
