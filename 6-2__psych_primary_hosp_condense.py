...
def dx_condense1(df):
    output_filepath = '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_grouped1_prim.csv'

    cdrn_ccs_results = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_results1_.csv',
                                   encoding='utf-8')
...
def dx_condense2(df):
    output_filepath = '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_grouped2_prim.csv'

    cdrn_ccs_results = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_results2_.csv',
                                   encoding='utf-8')
    print("Number of unique person_id in cdrn_ccs_results: ", cdrn_ccs_results.person_id.nunique())
...
def dx_condense3(df):
    output_filepath = '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_grouped3_prim.csv'

    cdrn_ccs_results = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_results3_.csv',
                                   encoding='utf-8')
    print("Number of unique person_id in cdrn_ccs_results: ", cdrn_ccs_results.person_id.nunique())
...
def dx_condense4(df):
    output_filepath = '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_grouped4_prim.csv'

    cdrn_ccs_results = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_results4_.csv',
                                   encoding='utf-8')
    print("Number of unique person_id in cdrn_ccs_results: ", cdrn_ccs_results.person_id.nunique())
...
def utilization(df):
    output_filepath = '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/psych_primary_casecontrol_visit.csv'
    visits = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_all_visits_1218.csv',
