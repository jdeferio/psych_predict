...
cdrn = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_clin_util_all_nta_allhosp.csv', encoding='utf-8')
...
plt.title('Receiver operating characteristic: Clinical + 1600m SDOH (All Hospitalizations)')
plt.legend(loc="lower right")
plt.savefig('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/ROC_Clin_1600m_AllHosp.png')
plt.savefig('/Users/jdeferio/Documents/ROC_Clin_1600m_AllHosp.png')
plt.show()
