...
cdrn_ccw_grouped = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_grouped_all.csv',encoding='utf-8')
...
output_filepath2 = '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified_all_demo.csv'

output_filepath3 = '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified_all_loc.csv'
...
def dx_convert(df):
    ...
    output_filepath =  '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified_all.csv'
...
cdrn_ccw_modified = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified_all.csv',encoding='utf-8')
...
cdrn_all_hosp_2014_1st_ = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_all_hosp_2014_1st_.csv',encoding='utf-8')
...
all_hosp_list_final = []
for _ in cdrn_ccw_modified_loc['person_id']:
    if _ in (list(cdrn_all_hosp_2014_1st_['person_id'])):
        all_hosp_list_final.append(1)
    else: all_hosp_list_final.append(0)

person_hosp = pd.DataFrame({"person_id":person_list2,"hosp_any":all_hosp_list_final})
...
pd.DataFrame(cdrn_ccw_modified_nta).to_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified_nta_all.csv',encoding='utf-8')