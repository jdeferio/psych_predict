...
# IMPORT DATA
case_control = pd.read_csv('data/cdrn_psych_casecontrol2.csv',
                      encoding='utf-8')

# COMBINE GROUPED DIAGNOSIS DATA
def ccs_aggregate(df):
    cdrn_ccs_grouped1 = pd.read_csv('data/cdrn_ccs_grouped1.csv',encoding='utf-8')
    print("cdrn_ccs_grouped length1: {}".format(len(cdrn_ccs_grouped1)))
    cdrn_ccs_grouped2 = pd.read_csv('data/cdrn_ccs_grouped2.csv',encoding='utf-8')
    print("cdrn_ccs_grouped length2: {}".format(len(cdrn_ccs_grouped2)))
    cdrn_ccs_grouped3 = pd.read_csv('data/cdrn_ccs_grouped3.csv',encoding='utf-8')
    print("cdrn_ccs_grouped length3: {}".format(len(cdrn_ccs_grouped3)))
    cdrn_ccs_grouped4 = pd.read_csv('data/cdrn_ccs_grouped4.csv',encoding='utf-8')
...
def dx_convert(df):
    ...
    for _ in df['tuberculosis']:
        ccs_modified["tuberculosis"].append(_)
    ...
    for _ in df['hiv']:
        ccs_modified["hiv"].append(_)
    print("Completed Recoding of: 'hiv' ")

    for _ in df['hepatitis']:
        ccs_modified["hepatitis"].append(_)
    ...
    for _ in df['colon_ca']:
        ccs_modified["colon_ca"].append(_)
    print("Completed Recoding of: 'colon_ca' ")

    for _ in df['rectum_ca']:
        ccs_modified["rectum_ca"].append(_)
    ...
    for _ in df['breast_ca']:
        ccs_modified["breast_ca"].append(_)
    print("Completed Recoding of: 'breast_ca' ")

    for _ in df['uterus_ca']:
        ccs_modified["uterus_ca"].append(_)
    ...
    for _ in df['prostate_ca']:
        ccs_modified["prostate_ca"].append(_)
    ...
    for _ in df['kidney_ca']:
        ccs_modified["kidney_ca"].append(_)
    print("Completed Recoding of: 'kidney_ca' ")

    for _ in df['urinary_ca']:
        ccs_modified["urinary_ca"].append(_)
    ...
    for _ in df['lipid_metabo']:
        ccs_modified["lipid_metabo"].append(_)
    ...
    for _ in df['immunity']:
        ccs_modified["immunity"].append(_)
    ...
    for _ in df['cardiac_dysrhythm']:
        ccs_modified["cardiac_dysrhythm"].append(_)
    ...
    for _ in df['chf']:
        ccs_modified["chf"].append(_)
    print("Completed Recoding of: 'chf' ")

    for _ in df['acute_cvd']:
        ccs_modified["acute_cvd"].append(_)
    ...
    for _ in df['tran_cereb_isch']:
        ccs_modified["tran_cereb_isch"].append(_)
    ...
    for _ in df['copd']:
        ccs_modified["copd"].append(_)
    print("Completed Recoding of: 'copd' ")

    for _ in df['asthma']:
        ccs_modified["asthma"].append(_)
    ...
    for _ in df['other_liver']:
        ccs_modified["other_liver"].append(_)
    ...
    for _ in df['other_kidney']:
        ccs_modified["other_kidney"].append(_)
    ...
    for _ in df['prostate_hyp']:
        ccs_modified["prostate_hyp"].append(_)
    ...
    for _ in df['chronic_skin_ulcer']:
        ccs_modified["chronic_skin_ulcer"].append(_)
    ...
    for _ in df['rheum_arth']:
        ccs_modified["rheum_arth"].append(_)
    print("Completed Recoding of: 'rheum_arth' ")

    for _ in df['osteo_arth']:
        ccs_modified["osteo_arth"].append(_)
    ...
    for _ in df['ns_congen_anom']:
        ccs_modified["ns_congen_anom"].append(_)
    print("Completed Recoding of: 'ns_congen_anom' ")

    for _ in df['other_congen_anom']:
        ccs_modified["other_congen_anom"].append(_)
    ...
    for _ in df['fract_femur_neck']:
        ccs_modified["fract_femur_neck"].append(_)
    print("Completed Recoding of: 'fract_femur_neck' ")

    for _ in df['spinal_cord']:
        ccs_modified["spinal_cord"].append(_)
    ...
    for _ in df['other_fract']:
        ccs_modified["other_fract"].append(_)
    ...
    for _ in df['malaise_fatigue']:
        ccs_modified["malaise_fatigue"].append(_)
...
# def add_location(df):
#     loc = pd.read_csv('data/cdrn_dedup_loc_all.csv', encoding='utf-8')
#
...
def hosp_label(df):
    cdrn_psych_hosp_bef_18 = pd.read_csv(
        'data/cdrn_psych_hosp_bef_18.csv', encoding='utf-8',
        names=['person_id', 'inpt_hosp_date', 'visit_occurrence_id', 'visit_concept_id', 'condition_type_concept_id'])
...
def no_dx_hist(df):
    ...
    pd.DataFrame(df2).to_csv('data/cdrn_ccs_modified_label2.csv',encoding='utf-8')
    return df2
...
#     df2 = df.merge(case_control, on='person_id', how='inner')
#
#     pd.DataFrame(df2).to_csv('data/cdrn_ccs_modified_nta.csv',encoding='utf-8')
#
#     return df2
