...
case_control = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_psych_primary_casecontrol.csv',
                      encoding='utf-8')

def ccs_aggregate(df):

    cdrn_ccs_grouped1 = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_grouped1_prim.csv',encoding='utf-8')
    print("cdrn_ccs_grouped length1: {}".format(len(cdrn_ccs_grouped1)))
    cdrn_ccs_grouped2 = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_grouped2_prim.csv',encoding='utf-8')
    print("cdrn_ccs_grouped length2: {}".format(len(cdrn_ccs_grouped2)))
    cdrn_ccs_grouped3 = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_grouped3_prim.csv',encoding='utf-8')
    print("cdrn_ccs_grouped length3: {}".format(len(cdrn_ccs_grouped3)))
    cdrn_ccs_grouped4 = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_grouped4_prim.csv',encoding='utf-8')
...
def dx_convert(df):
    # output_filepath =  '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_modified.csv'

    visits = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/psych_primary_casecontrol_visit.csv',
                         encoding='utf-8')
...
def hosp_label(df):
    cdrn_psych_hosp_bef_18 = pd.read_csv(
        '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_psych_primary_hosp_bef_18.csv', encoding='utf-8',
...
def no_dx_hist(df):
    ...
    pd.DataFrame(df2).to_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_modified_label_primary.csv',encoding='utf-8')
    return df2
...
#     df2 = df.merge(case_control, on='person_id', how='inner')
#
#     pd.DataFrame(df2).to_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccs_modified_nta.csv',encoding='utf-8')
#
#     return df2
