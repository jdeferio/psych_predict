...
def outpt_drugs(df):
    de = pd.read_csv('data/cdrn_drug_exposure_1218.csv', encoding='utf-8', names=['person_id', 'drug_exposure_start_date', 'concept_name', 'drug_class'])
    ...
    pd.DataFrame(de3).to_csv('data/psych_outpt_drug_exp_1218.csv', encoding='utf-8') # saves drug exposure df
