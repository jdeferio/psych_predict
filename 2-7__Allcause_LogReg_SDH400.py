...
plt.title('Receiver operating characteristic: Clinical + 400m SDOH (All Hospitalizations)')
plt.legend(loc="lower right")
plt.savefig('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/ROC_Clin_400m_AllHosp.png')
plt.savefig('/Users/jdeferio/Documents/ROC_Clin_400m_AllHosp.png')
plt.show()
