...
cdrn_ccw_grouped = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_grouped.csv',encoding='utf-8')
...
output_filepath2 = '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified_demo.csv'

output_filepath3 = '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified_loc.csv'
...
def dx_convert(df):
    ...
    output_filepath =  '/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified.csv'
...
cdrn_ccw_modified = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified.csv',encoding='utf-8')
...
for _ in cdrn_ccw_modified_loc['person_id']:
    if _ in (list(cdrn_psych_hosp_2014_1st_['person_id'])):
...
cdrn_ccw_modified_loc = pd.merge(cdrn_ccw_modified_loc,person_psych, how='left', on='person_id')
...
pd.DataFrame(cdrn_ccw_modified_nta).to_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified_nta.csv',encoding='utf-8')