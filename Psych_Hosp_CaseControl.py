...
# IMPORT DATA
hosp = pd.read_csv('data/cdrn_psych_hosp_bef_18.csv', encoding='utf-8', names=['person_id', 'inpt_hosp_date', 'visit_occurrence_id', 'visit_concept_id', 'condition_type_concept_id']) # cdrn_psych_primary_hosp_bef_18.csv
diagnosis = pd.read_csv('data/cdrn_psych_dx_bef_18.csv', encoding='utf-8', names=['person_id', 'psych_dx_date'])
visits = pd.read_csv('data/cdrn_all_visits_1218.csv', encoding='utf-8', names=['person_id', 'visit_occurrence_id', 'visit_start_date', 'visit_concept_id'])
no_hosp = pd.read_csv('data/cdrn_no_psych_hosp_bef_18.csv', encoding='utf-8', names=['person_id', 'condition_start_date', 'condition_source_value'])
demographics = pd.read_csv('data/cdrn_pt_demographics.csv', encoding='utf-8', names=['person_id', 'gender_concept_id', 'birth_date'])
