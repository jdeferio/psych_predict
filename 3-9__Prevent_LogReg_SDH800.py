...
plt.title('Receiver operating characteristic: Clinical + 800m SDOH (Preventable Hospitalizations)')
plt.legend(loc="lower right")
plt.savefig('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/ROC_Clin_800m_Prevent.png')
plt.savefig('/Users/jdeferio/Documents/ROC_Clin_800m_Prevent.png')
plt.show()
