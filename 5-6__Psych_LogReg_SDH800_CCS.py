...
plt.title('Receiver operating characteristic: Clinical + 800m SDOH (Psychiatric Hospitalizations)')
plt.legend(loc="lower right")
plt.savefig('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/CCS_ROC_Clin_800m_Psych.png')
plt.savefig('/Users/jdeferio/Documents/CCS_ROC_Clin_800m_Psych.png')
plt.show()