...
cdrn = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_ccw_modified_nta_all.csv', encoding='utf-8')

cdrn_util2014_grouped = pd.read_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_util2014_allcause_grouped.csv', encoding='utf-8')
...
# Any Hospitalizations
pd.DataFrame(cdrn1).to_csv('/Users/jdeferio/PycharmProjects/CDRN_Individual/venv/cdrn_clin_util_all_nta_allhosp.csv', encoding='utf-8')
