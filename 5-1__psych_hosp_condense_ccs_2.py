...
def dx_condense1(df):
    ...
    cdrn_ccs_results = pd.read_csv(PATH+'cdrn_ccs_results1_.csv',
                                   encoding='utf-8')
...
def dx_condense2(df):
    ...
    cdrn_ccs_results = pd.read_csv(PATH+'cdrn_ccs_results2_.csv',
                                   encoding='utf-8')
    print("Number of unique person_id in cdrn_ccs_results: ", cdrn_ccs_results.person_id.nunique())
...
def dx_condense3(df):
    ...
    cdrn_ccs_results = pd.read_csv(PATH+'cdrn_ccs_results3_.csv',
                                   encoding='utf-8')
    print("Number of unique person_id in cdrn_ccs_results: ", cdrn_ccs_results.person_id.nunique())
...
def dx_condense4(df):
    ...
    cdrn_ccs_results = pd.read_csv(PATH+'cdrn_ccs_results4_.csv',
                                   encoding='utf-8')
    print("Number of unique person_id in cdrn_ccs_results: ", cdrn_ccs_results.person_id.nunique())
