...
# IMPLEMENT THE MODEL
cols = ['alzheimers','a_fib','cataract','depression','diabetes','heart_fail','hip_pelv_frac','hyperlipid','htn','ischemic_hd','stroke_tia','colorectal_ca','prostate_ca','lung_ca','endometrial_ca','anxiety','autism','bipolar','cerebral_p','cystic_f','epilepsy','iq_disable','learn_disable','leukemia','mobility','ms_tm','muscular_dys','personality','ulcers','schizo','spina_bifida','spinal_cord','hepatitis','suicide','inpt_2012']
...
plt.title('Receiver operating characteristic: Clinical + 400m SDOH')
